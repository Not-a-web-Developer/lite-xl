...
function core.init()
  core.log_items = {}
  core.log_quiet("Left XL version %s - mod-version %s", VERSION, MOD_VERSION_STRING)
  ...
  config.plugins.autocomplete = config.plugins.autocomplete or false
...
function core.compose_window_title(title)
  return (title == "" or title == nil) and "Left XL" or title .. " - Left XL"
end
