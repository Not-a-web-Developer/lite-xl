...
style.font = renderer.font.load(DATADIR .. "/fonts/FiraSans-Regular.ttf", 15 * SCALE, {antialiasing="grayscale", hinting="full"})
...
style.code_font = renderer.font.load(DATADIR .. "/fonts/JetBrainsMono-Regular.ttf", 15 * SCALE, {antialiasing="grayscale", hinting="full"})
